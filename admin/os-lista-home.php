...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a href="admin.php?link=21">O.S Dia <?php echo Date('d/m/Y'); ?></a></li>
		</ol>
	</section>
								...
								foreach ($dados as $linha) {
									...
									<tr>
										...
										<td>
											...
											<a href="admin.php?link=22&id=<?php echo $linha["id_os"]; ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
											<a href="admin.php?link=23&acao=delete&id=<?php echo $linha["id_os"]; ?>" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a>
										</td>
									</tr>
								<?php }?>
							</tbody>
