...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="admin.php?link=21">O.S</a></li>
      <li class="active"><a href="admin.php?link=22&id=<?php echo $os["id_os"]; ?>">Editar</a></li>
    </ol>
  </section>
    ...
    <div class="row">
     <div class="col-md-12">
      <div class="box box-success">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="admin.php?link=23&acao=update" method="post">
          <div class="box-body">
