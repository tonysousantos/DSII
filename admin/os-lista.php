...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a href="admin.php?link=18">Lista de O.S</a></li>
		</ol>
	</section>
			...
			<div class="col-md-12">
				<div class="box box-primary">
					...
					<div class="box-header">
						<a href="admin.php?link=17" class="btn btn-success"><i class="fa fa-user-plus"></i> Cadastrar O.S</a>
					...
					<div class="box-body no-padding">
						<table class="table table-striped">
							...
							<tbody>
								...
								if($pesq != ""){
									$dados = CadastroOs::search($pesq);
								}else{
									$dados = CADASTROOS::getList();
								}
								...
								foreach ($dados as $linha) {
									...
									<tr>
										...
										<td>
											...
											<a href="admin.php?link=19&id=<?php echo $linha["id_os"]; ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
											<a href="admin.php?link=20&acao=delete&id=<?php echo $linha["id_os"]; ?>" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a>
										</td>
									</tr>
								<?php }?>
							</tbody>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="admin.php?link=18" method="post">
